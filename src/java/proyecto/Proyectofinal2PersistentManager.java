...
public class Proyectofinal2PersistentManager extends PersistentManager {
	private static final String PROJECT_NAME = "Proyectofinal2";
	...
	private Proyectofinal2PersistentManager() throws PersistentException {
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new Proyectofinal2PersistentManager();
		}
