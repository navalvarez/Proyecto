...
public class Tallerv77PersistentManager extends PersistentManager {
	private static final String PROJECT_NAME = "Tallerv77";
	...
	private Tallerv77PersistentManager() throws PersistentException {
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new Tallerv77PersistentManager();
		}
